...
public class BinaryTreeAnimationBuilderTest {
	...
	private static final Coordinates BUILDER_GRAPHROOT_COORDS = new Coordinates(300,275);
	...
	private BinaryTreeLayout createTestLayout() {		
		BinaryTreeLayout layout = new BinaryTreeLayout(BUILDER_GRAPHROOT_COORDS, FIRST_LEVEL_WIDTH, VERTICAL_SPACING);
		return layout;
	}


	private BinaryTreeModel<Integer> createInitialModel(int size) {		
		BinaryTreeModel<Integer> model = BuilderTestUtils.createNElementTree(size);
		return model;
	}
	...
	public void displayCurrentTree(){
		...
		BinaryTreeModel<Integer> model = createInitialModel(7);
	...
	public void generatesNodesAccordingToLayout() throws Exception {
		int elements = 20;
		BinaryTreeModel<Integer> nElementTree = BuilderTestUtils.createNElementTree(elements);
